...
def test_create_with_no_assignee(webhook_request_example):
...
def test_create_with_assignee(webhook_request_example):
    webhook_request_example.bug.assigned_to = "dtownsend@mozilla.com"
...
def test_clear_assignee(webhook_request_example):
    webhook_request_example.bug.see_also = [
        "https://mozilla.atlassian.net/browse/JBI-234"
    ]
    webhook_request_example.event.action = "modify"
    webhook_request_example.event.routing_key = "bug.modify:assigned_to"
...
def test_set_assignee(webhook_request_example):
    webhook_request_example.bug.assigned_to = "dtownsend@mozilla.com"
    webhook_request_example.bug.see_also = [
        "https://mozilla.atlassian.net/browse/JBI-234"
    ]
...
def test_create_with_unknown_status(webhook_request_example):
    webhook_request_example.bug.status = "NEW"
    webhook_request_example.bug.resolution = ""
...
def test_create_with_known_status(webhook_request_example):
    webhook_request_example.bug.status = "ASSIGNED"
    webhook_request_example.bug.resolution = ""
...
def test_change_to_unknown_status(webhook_request_example):
    webhook_request_example.bug.status = "NEW"
    webhook_request_example.bug.resolution = ""
    webhook_request_example.bug.see_also = [
        "https://mozilla.atlassian.net/browse/JBI-234"
    ...
    webhook_request_example.event.action = "modify"
    webhook_request_example.event.routing_key = "bug.modify:status"
...
def test_change_to_known_status(webhook_request_example):
    webhook_request_example.bug.status = "ASSIGNED"
    webhook_request_example.bug.resolution = ""
    webhook_request_example.bug.see_also = [
        "https://mozilla.atlassian.net/browse/JBI-234"
...
def test_change_to_known_resolution(webhook_request_example):
    webhook_request_example.bug.status = "RESOLVED"
    webhook_request_example.bug.resolution = "FIXED"
    webhook_request_example.bug.see_also = [
        "https://mozilla.atlassian.net/browse/JBI-234"
    ]
    webhook_request_example.event.action = "modify"
    webhook_request_example.event.routing_key = "bug.modify:resolution"
